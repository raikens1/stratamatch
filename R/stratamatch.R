...
#' Hansen (2008)) on the pilot set, and stratifying the data set based on
#' prognostic score quantiles.  The \code{\link{strata_match}} function then
#' does optimal matching of the data set within strata.
#'
